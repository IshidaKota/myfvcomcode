...
! Error message
!
!  jsasaki start '(I1)' only valid for integer and error in case of real
!     CHARS = NUMSTR(MXWCP+1,RNAN,'(I1)')
     if (MXWCP+1 /= INAN) then
       WRITE(CHARS,'(I1)') MXWCP+1
     end if
!  jsasaki end '(I1)' only valid for integer and error in case of real
